            ...
            <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                   ...
                   <div class="col">
                   <label for=""> NPM</label>
                    <input type="number" name="npm" class="form-control" placeholder="Masukan NPM" maxlength="8" value="{{ is_null($mahasiswa) ? '' : $mahasiswa->npm}}">
                   </div>
                   ...
                   <label for=""> Telepon</label>
                    <input type="number" name="telepon" class="form-control" placeholder="Tambahkan No Telepon" value="{{ is_null($mahasiswa) ? '' : $mahasiswa->telepon}}">
                   </div>
                   </div>
                   </div>
